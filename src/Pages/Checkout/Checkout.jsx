                ...
                <div className='checkoutBody'>
                    <div className='ccontainer' >
                        ...
                        <div>
                            ...
                            {
                                cart?.map((ele) => <div className='Cflex' style={{ fontWeight: "bold", fontSize: "1rem" }}>
                                    <div style={{ marginLeft: "20px" }}>{ele.product.title||ele.product.desc||ele.product.subtitle}</div>
                                    <div style={{ marginRight: "20px" }}>${ele.product.price}</div>
                                </div>)
                            }
