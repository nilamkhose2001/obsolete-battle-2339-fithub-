...
const Card = ({ id,img,title,subtitle,price, primaryvalue,link,calories,trainingtype,UpdateChange }) => {
  ...
  return (
    <Box  p={5} bg="gray.200"   borderRadius={20} as="article">
       ...
       <Text fontSize="22" color="teal" > {title} </Text> 
       <Flex width={["100%","90%","90%","100%"]} justifyContent="space-evenly">
        <Text fontSize="20" color="gray" fontWeight="500">Exclusive </Text>
        <Text fontSize="17" color="violet" fontWeight="600" ml="2">{subtitle||"Bored-Easily Strength Intervals"}</Text>
       </Flex>
       ...
       <Flex justifyContent="space-between" mt="5">
         <UpdateWorkout id={id} UpdateChange={UpdateChange} link={link} trainingtype={trainingtype} price={price} primaryvalue={primaryvalue} title={title} subtitle={subtitle} img={img} calories={calories}/>         
